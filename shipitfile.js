module.exports = function (shipit) {
	...
	shipit.initConfig({
		default: {
			workspace: '/tmp/shipit-marriedinnewyork',
			deployTo: '/srv/users/serverpilot/apps/marriedinnewyork',
			repositoryUrl: 'git@bitbucket.org:chrisroweltd/marriedinnewyork.git',
			branch: 'master',
