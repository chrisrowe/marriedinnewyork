...
class Package_installer
{
	...
	private function create_field($field)
	{
		...
		if (@$this->local_field_data['field_type'] == 'date' || @$this->local_field_data['field_type'] == 'rel')
		{
		...
		{
 			call_user_func(array($this, 'create_field_'.$this->local_field_data['field_type']), $field_id, $field_type_data, $this->local_field_data);
		}
